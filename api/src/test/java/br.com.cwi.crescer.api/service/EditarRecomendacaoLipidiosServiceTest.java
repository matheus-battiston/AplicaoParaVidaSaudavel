...
import br.com.cwi.crescer.api.security.service.EditarRecomendacaoLipidiosService;
...
public class EditarRecomendacaoLipidiosServiceTest {
    @InjectMocks
    ...
    @Test
    @DisplayName("Deve editar a recomendação de lipidios corretamente")
    void deveEditarRecomendacaoLipidios(){
        Usuario usuario = get();
        ...
        assertEquals(request.getValor(), usuario.getLipidiosRecomendacao());
    }
}
