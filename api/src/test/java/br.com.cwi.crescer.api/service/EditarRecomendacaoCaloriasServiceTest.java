...
import br.com.cwi.crescer.api.security.service.EditarRecomendacaoCaloriasService;
...
public class EditarRecomendacaoCaloriasServiceTest {
    @InjectMocks
    ...
    @Test
    @DisplayName("Deve editar a recomendação de calorias corretamente")
    void deveEditarRecomendacaoCalorias(){
        Usuario usuario = get();
        ...
        assertEquals(request.getValor(), usuario.getCaloriasRecomendacao());
    }
}
